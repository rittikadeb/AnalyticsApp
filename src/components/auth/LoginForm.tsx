    ...
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-2xl border border-transparent dark:border-gray-800 p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Analytics Web App</h1>
        ...
        <div className="mt-4 text-center space-y-2">
          <button onClick={onSwitchToReset} className="text-sm text-blue-600 dark:text-blue-400 hover:underline">
            Forgot your password?
          </button>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Don&apos;t have an account?{' '}
            <button onClick={onSwitchToRegister} className="text-blue-600 dark:text-blue-400 hover:underline font-medium">
              Create one
            </button>
          </p>
        </div>
